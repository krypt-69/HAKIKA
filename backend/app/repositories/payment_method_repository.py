...
class PaymentMethodRepository:
    ...
    async def create(self, business_id: uuid.UUID, type: PaymentMethodType, account_number: str, paybill_short_code: str | None = None) -> PaymentMethod:
        ...
        pm = PaymentMethod(
            ...
            paybill_short_code=paybill_short_code
        )
        self.db.add(pm)
