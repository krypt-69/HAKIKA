...
from app.api.v1.endpoints import home_snippet
from app.api.v1.endpoints.business_riders import router as business_riders_router
api_router.include_router(notifications.router, tags=["notifications"])
api_router.include_router(product_categories.router, tags=["product_categories"])
api_router.include_router(home_snippet.router, tags=["home_snippet"])
